<div id="page-wrapper" style="min-height: 345px;">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body collapse" id="collapseExample">
            <?php
            echo form_open(base_url() . "superadmin/c_err_mst/save_err", "id='err_form'");
            ?>
            <div class="row bottom_gap">
                ...
                <div class="col-lg-4">
                    <div class="input-group">
                        <div class="form-group">
                            <?php echo form_input("ErrCode", "", array("class" => "'form-control popover_element'", "placeholder" => "'Error Code'", "maxlength" => "25", "data-toggle" => "'popover'", "data-placement" => "'top'", "data-content" => "' It will help to identify error.'", "data-original-title" => "'Remember'")) ?>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group"> 
                        <?php echo form_input("ErrCodeDes", "", array("class" => "'form-control popover_element'", "placeholder" => "'Error'", "maxlength" => "150", "data-toggle" => "'popover'", "data-placement" => "'top'", "data-content" => "'It will help to discribe Error.'", "data-original-title" => "'Remember'")) ?>
                    </div>
                </div>
            </div> 
            <div class="row bottom_gap"> 
                ...
                <div class="col-lg-2">Error Status</div> 
                <div class="col-lg-4">
