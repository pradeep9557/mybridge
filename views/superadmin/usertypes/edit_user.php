<div id="page-wrapper" style="min-height: 345px;">
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php
//            die($this->util_model->printr($uEditdetail));
            if (isset($error)) {
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body collapse" id="collapseExample">   
            ...
            echo form_open_multipart(base_url() . 'sp-admin/a/updateUtype', "id='UpdateUserTypeForm'");
            ?>
            <div class="row bottom_gap">
                <div class="col-lg-2 col-md-2 col-sm-4 padding_top_label">UserType<span class="Compulsory">*</span></div>
                <div class="col-lg-4 col-md-4 col-sm-8">
                    <div class="form-group">
                        <?php echo form_input("UserTypeName", $uEditdetail['UserTypeName'], array("class" => "'form-control  popover_element1'", "placeholder" => "'UserType'","maxlength" => "50")) ?>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        echo form_dropdown('Status', $options, "", 'class="form-control" placeholder="Status" value=""');
                        ?>
                    </div>	
                </div>
            </div> <!--End of row-->    
            ...
            <div class="row bottom_gap">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <?php echo form_input("Sort", $uEditdetail['Sort'], array("class" => "'form-control'", "placeholder" => "'Sort Order'", "maxlength" => "2")) ?>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        echo form_dropdown('Level', $options,$uEditdetail['level'] , 'class="form-control" placeholder="" ');
                        ?>
                    </div>	
                </div> </div> <!--End of row-->
				  <div class="row bottom_gap">
...
<?php
                        ...
                        echo form_dropdown('UserTypeGroup', $UserGroupList	, $uEditdetail['UserTypeGroup'], 'class="form-control" placeholder="" ');
                        ?>
                    </div>	
                </div>
            </div> <!--End of row-->
            ...
            <input type="hidden" name="utid" value=<?php echo $uEditdetail['UTID']?> />
            <?php
            echo form_close();
            ?>
        </div>
...
<script>
 $('#UpdateUserType').bootstrapValidator({
        feedbackIcons: {
        ...
        fields: {
            UserTypeName: {// Edit User Type Name
                validators: {
                    notEmpty: {
