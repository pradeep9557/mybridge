...
<!--                <li class="dropdown">
                ...
                <li class="dropdown">
                    <i class="fa fa-user fa-fw"></i> Welcome <?=$Session_Data['IBMS_USER_ID_NAME']?>(<?=$Session_Data['IBMS_USER_TYPE']?>)
                </li>
                <li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       <!-- <li class="sidebar-search">
                        ...
                        <li>
                            <a href="#page-wrapper" class="page-scroll"> Basic Details</a>
                            <a href="#Pre_Fee_Plans" class="page-scroll"> Fee Records</a>
                            <a href="#Pre_Fee_Plans" class="page-scroll"> Fee Plan</a>
