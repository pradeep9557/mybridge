...
<div id="page-wrapper" style="min-height: 345px;">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header ">New Qualification</h4>
    ...
    <div class="row bottom_gap">
        ...
        <div class="col-lg-4">
            <div class="form-group">
                <?php echo form_input("Code", "", array("class" => "'form-control'", "placeholder" => "'Qualification Code'", "maxlength" => "15")) ?>
            </div>	
        </div><!-- /form-group -->               
        <!-- end of col-lg-4 -->
        ...
        <div class="col-lg-4">
            <div class="form-group">
                <?php echo form_input("Name", "", array("class" => "'form-control'", "placeholder" => "'Qualification Name'", "maxlength" => "43")) ?>
            </div>
        </div>
    </div> <!--End of row-->
    <!--String of Row-->
    ...
    <div class="row col-lg-12">
        <button type="submit" name="Add_qualification" value="Save" class="btn btn-success btn-md">
    ...
    $Curr_Obj->All_qualification_List();
    ?>
</div>
<script>
    //      Form Validation           
    $(document).ready(function() {
        $('#new_qualification_form').bootstrapValidator({
            feedbackIcons: {
