<div id="page-wrapper" style="min-height: 345px;">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header">Add New State</h4>
            <?php
            if (isset($error)) {
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body collapse" id="collapseExample">
             <?php 
             echo form_open(base_url()."Enquiry/c_state/save_state","id='state_form'");
            ?>
            <div class="col-lg-12 bottom_gap">
                <div class="row bottom_gap">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">	
                            <?php echo form_dropdown("country_id", $country_list, "", "class='form-control chosen-select'") ?>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            <div class="form-group">
                                <?php echo form_input("code", "", array("id" => "StateCode", "checking_id" => "'4'", "class" => "'form-control check_already_exits  popover_element1'", "data-content" => "'State Code required,  3-32 characters'", "placeholder" => "'State Code'", "maxlength" => "32")) ?>
                            </div>
                ...
                <div class="row bottom_gap">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group">
                            <div class="form-group">
                                <?php echo form_input("name", "", array("id" => "StateName", "checking_id" => "'4'", "class" => "'form-control check_already_exits  popover_element1'", "data-content" => "'State Name required, 3-128 characters'", "placeholder" => "'State Name'", "maxlength" => "128")) ?>
                            </div>
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-default btn-md search_already_exits" tabindex="-1" search_for="CountryName">
                                    <span class="glyphicon glyphicon-search"></span>
