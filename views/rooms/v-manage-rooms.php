...
<<div id="page-wrapper" style="min-height: 345px;">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header">Manage Rooms
                <a href="<?php echo base_url(); ?>batch/batch_master" class="pull-right">
                    <button type="button" name="link" value="Save" class="btn btn-success btn-md margin_top-10px">
                        <span class="glyphicon glyphicon-send"></span> Allocate Rooms
                    </button></a>
            </h4>
            <?php
            if (isset($error)) {
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading" data-toggle="collapse" data-target="#collapseExample">
                    <h3 class="panel-title toggle_custom">Manage Rooms
                        <span class="glyphicon glyphicon-chevron-down glyphicon-chevron-up pull-right" ></span></h3>
                </div>  

                <div class="panel-body collapse" id="collapseExample">
                    <?php
                    echo form_open(base_url() . "rooms/c_room/insert_data", "id='room_mst'");
                    ?>
                    <div class="row bottom_gap">
                        <div class="col-lg-2">Room Code</div>
                        <div class="col-lg-4"><?php echo form_input('rcode', "", "class='form-control' Placeholder='Room Code'") ?></div>
                        <div class="col-lg-2">Max. Student</div>
                        <div class="col-lg-4"><?php echo form_input('max_students', "", "class='form-control' Placeholder='Max number of Students'") ?></div>
                    </div> 
                        <div class="row">
                                  
                                    
                                  <?php echo $set_time_form; ?>
