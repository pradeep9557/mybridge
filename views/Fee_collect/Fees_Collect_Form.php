...
<div id="page-wrapper" style="min-height: 345px;">
    ...
    <div class="row padding_left_0px">
        ...
        ?>
        <form action="<?= base_url() ?>fees/Fee_Master/index" method="POST" id="Fee_collect_EnrollNo_Form">
            <div class="col-lg-2">
                <div class="form-group">
                    <input type='hidden' name="CourseID" value="<?php echo $CourseID ?>"> 
                    <input type="text" value="<?php echo $EnrollNo ?>" class="form-control" id="EnrollNo_Search" name="EnrollNo" placeholder="EnrollNo" onblur="get_course_list(this)" result_id="courselist1" fname="CourseID"/></div>
            </div>
            <div class="col-lg-2">
            ...
            <div class="col-md-2">
                <a href="<?php echo base_url() ?>fees/Fee_Master/index/<?php echo $Stu_ID . "/" . $CourseID ?>" class="page-scroll"><button type="button" class="btn btn-primary btn-md" id="all_fee_record">
                        <span class="glyphicon glyphicon-refresh">  </span>Refresh
                    </button></a>
                <?php 
                 echo $Form_Field_Value['Pro_pic'];
                ?>

            </div>
        </form>
    </div>
    <div class="row padding_left_0px padding_top_label">
        <?php
        $this->load->view('Fee_collect/due_day_form');
        ?>
    </div>
    <div class="row">
        <div class="col-lg-12 bottom_gap">
            ...
            if ($EnrollNo != "" && $Fully_Paid && $Form_Field_Value['PreBalAmt'] == 0) {
                          ...
                          <a class="page-scroll" href="<?= base_url() . 'fees/Fee_Master/sscfp/' . $Stu_ID . "/" . $CourseID ?>">    
...
//  echo form_open('/dashboard/new_admission',$attributes);
    echo form_open_multipart(base_url() . 'fees/Fee_Master/fee_collect', "id='fee_collect_form'");
    if (!empty($FeeTypeID_list)) {
                  if (!$Fully_Paid) {
                            ...
                            echo form_input("FeeTypeIDshow", isset($FeeTypeID_list[$FeeTypeID])?$FeeTypeID_list[$FeeTypeID]:"", "class='form-control' readonly");
