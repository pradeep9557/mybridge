...
//  echo form_open('/dashboard/new_admission',$attributes);
    echo form_open_multipart(base_url() . 'fees/Fee_Master/fee_update', "id='fee_collect_form'");
//    if (!empty($FeeTypeID_list) && !$Fully_Paid) {
                  ?>
                  <!--String of Row-->
                  ...
                  <div class="row bottom_gap">
                      <div class="col-lg-8">
                          ...
                          <div class="col-lg-12 bottom_gap">
                              ...
                              <button type="reset" name="Reset" value="Update" class="btn btn-success btn-md">
    ...
    <?php
//    } else {
//                  echo "<div class='col-lg-12'><span class='box'>There is no any fee type in your system. or Student is Fully Paid</span></div>";
//    }
    echo form_close();
    ?>
