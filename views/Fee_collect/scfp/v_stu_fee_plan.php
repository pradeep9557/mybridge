<div class="row">
    <?php if (isset($Stu_ID) && isset($CourseID)) { ?>  
              <!--    <a href="<?php echo base_url() ?>fees/Fee_Master/sscfp/<?php echo $Stu_ID ?>/<?php echo $CourseID ?>"><button class="btn btn-sm btn-primary pull-right" style="margin: 5px 0px">
                          <span class="glyphicon glyphicon-edit"></span> Edit Fee Plan    
                      </button></a>-->
    <?php } ?>
            ...
            <tbody>
                ...
                foreach ($stu_exiting_fee_plan as $cfp) {
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <?php echo $cfp->CourseCode; ?>
                                  </td>
                                  <td>
                                      <?php echo $cfp->FeeTypeID; ?>
                                  </td>
                                  ...
                                  <td>
                                      <form>
                                           <a href="<?php echo base_url() ?>fees/Fee_Master/sscfp/<?php echo $Stu_ID ?>/<?php echo $CourseID ?>">
