            ...
            if (isset($timings_details) && count($timings_details)) {
                          ...
                          <tr>
                              ...
                              <td class="str_time_col">
                                  <div class="form-group">
                                      <div class='input-group date str_time' id="Trang2">
                                          <input type='text' class="form-control" name="str_time[]" value="<?= date("H:00", strtotime("09:00")) ?>" id="end_batch_time"/>
                                          <span class="input-group-addon">
                                              <span class="glyphicon glyphicon-time"></span>
                                          </span>
                                      </div
                              ...
                              <td class="end_time_col">
                                  <div class="form-group">
                                      <div class='input-group date end_time' id="Trang2">
                                          <input type='text' class="form-control" name="end_time[]" value="<?= date("H:00", strtotime("18:00")) ?>" id="end_batch_time"/>
                                          <span class="input-group-addon">
                                              <span class="glyphicon glyphicon-time"></span>
                                          </span>
                                      </div>
