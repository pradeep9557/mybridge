        ...
        <div class="row bottom_gap"> 
            ...
            <div class="col-lg-4 col-md-4 col-sm-8">
                <div class="form-group">
                    <?php
                    echo form_dropdown("progress_flag", $all_progress_flags, 0, "class='form-control  pg_flag'");
                    ?>
                </div>
<!--                    <select name="progress_ag" class="form-control  pg_ag">
        ...
        <div class="row bottom_gap"> 
            ...
            <div class="col-lg-4 col-md-4 col-sm-8">
                <div class='input-group date bdatetimepicker1'>
...
//            }
    ...
    $(document).on("ready", function () {
        var d = new Date();
        $('.bdatetimepicker1').datetimepicker();
