<div id="page-wrapper" style="min-height: 345px;">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header ">Manage Bill Type</h4>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading" data-toggle="collapse" data-target="#collapseExample">
            <h3 class="panel-title toggle_custom"><?php  echo $type?> Bill Type<span class="glyphicon glyphicon-chevron-down glyphicon-chevron-up pull-right" ></span></h3>
        </div>
        <div class="panel-body collapse" id="collapseExample">   
            <?php
            //for normal form
            //  echo form_open('/dashboard/new_admission',$attributes);
            echo form_open_multipart(base_url() . 'tms/manage_bills/add_bill_type', "id='managebilltype'");
            ?>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="form-group">
                        <input type="hidden" name="_action" value="<?php echo $action ?>">
                         <input type="hidden" name="" value="<?php @$typedata['id'] ?>">
                        <?php echo form_input("name", @$typedata['name'], array("class" => "'form-control  popover_element1'", "placeholder" => "'Bill Type Name'")) ?>
                    </div>
                </div>
                ...
                <tbody>
                    ...
                    foreach ($btypelist as $each_type) {
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                 <a href="<?php echo base_url() . "tms/manage_bills/add_bill_type" . "/" . $each_type['id'] . "/edit" ?>">
                                            <button type="button" value=""  class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-edit" title="Edit Bill type"></span>
                                            </button>
                                        </a>
         
                                     <button data-toggle="tooltip" title="Delete" type="button" class="btn btn-danger" onclick="del_type(<?php echo $each_type['id'] ?>)">
                                     <span class="glyphicon glyphicon-trash" title="Delete Bill Type"></span>
                                            </button>
