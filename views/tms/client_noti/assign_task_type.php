...
<div id="page-wrapper" style="min-height: 345px;">
    ...
    if (isset($_GET['client_id']) && $_GET['client_id'] != '') {
        ...
        echo form_open_multipart(base_url() . 'tms/client_noti/get_client_task?client_id=' . $_GET['client_id'], "id='save_client_task'");
        ?>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" id="add_task">
                        ...
                        <ul style="list-style-type: none; ">
                            ...
                            <li style="float: left;width: 300px;"> <input type="checkbox" <?php echo $value['task_id'] != '' ? 'checked' : '' ?> name="ttm_id[]" value="<?php echo $value['ttm_id'] ?>"><?php echo $value['ttm_name'] ?>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                            <div class="row">
...
<script>
    function get_client_data(that) {
        ...
        window.location.href = '<?php echo base_url() . '/tms/client_noti/get_client_task/?client_id=' ?>' + client_id;
    }
