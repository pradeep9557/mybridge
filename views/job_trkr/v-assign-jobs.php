                        ...
                        <tbody>
                            ...
                            foreach ($jobs_list as $List) {
                                          ...
                                          <tr class="odd gradeX">
                                              ...
                                              <td><a href="<?php echo base_url()."job_trkr/c_job_mst/add_remarks/".$List['JobID']; ?>">
                                                  <button type="button"   class="btn-sm btn btn-success"  title="Edit <?= mysql_real_escape_string($List['JobID']) ?>">
