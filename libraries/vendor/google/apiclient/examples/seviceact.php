...
$client_id = '107742042059574641188'; //Client ID
$service_account_name = 'tsmnexgennew@smart-pattern-133323.iam.gserviceaccount.com'; //Email Address
$key_file_location = dirname(__FILE__) . "/MyProject-18885b446cb5.p12"; //key.p12

echo strpos($client_id, "googleusercontent");
